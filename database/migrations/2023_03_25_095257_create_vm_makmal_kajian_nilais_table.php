...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vm_makmal_kajian_nilais', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pp_id');
            $table->foreign('pp_id')->references('id')->on('pemantauan_project');
            $table->boolean('pengecualian');
            $table->string('kos_selepas_makmal', 255);
            $table->string('laporan_file_name', 255);
    ...
    {
        Schema::dropIfExists('vm_makmal_kajian_nilais');
    }
};
