...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rp_permohonan_bahagian_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('rp_permohonan_id')->constrained('rp_permohonans');
            $table->foreignId('bahagian_id')->constrained('rp_permohonan_bahagians')->onDelete('cascade');
            ...
            $table->boolean('is_first')->default(0)->nullable();
            $table->boolean('is_readonly')->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('rp_permohonan_bahagian_details');
    }
};
