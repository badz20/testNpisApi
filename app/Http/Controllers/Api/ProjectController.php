...
class ProjectController extends Controller
{
    ...
    public function draftCreate()
    {
        ...
        try {
            //code...
            $result['bahagian'] = refBahagian::with('jabatan')->where('is_hidden','!=',1)->get();
            $result['bahagianEpu'] = BahagianEpuJpm::get();
    ...
    public function sendUpdateRequest(Request $request)
    {
        try{
            ...
            $users=\App\Models\User::where('id', $request->user_id)->first();   
    ...
    public function setPriority(Request $request)
    {
        ...
        try{
            ...
            else 
            {
                ...
                //print_r(count($result_data_new));exit;
    ...
    { 
        try {
            $user = Auth::user();
            $status1=9; $status2=16; $status3=19; $status4=20;
            if($request->usertype==1)
            {
