...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('yuran_perunding_suppliemtaries', function (Blueprint $table) {
            $table->id();
            $table->integer('yuran_id');
            ...
            $table->decimal('supply_value', $precision = 20, $scale = 2)->nullable();
    ...
    {
        Schema::dropIfExists('yuran_perunding_suppliemtaries');
    }
};
