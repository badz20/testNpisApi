...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('perunding_prestasi_rekord_lapirans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('prestasi_id')->references('id')->on('perunding_prestasis');
    ...
    {
        Schema::dropIfExists('perunding_prestasi_rekord_lapiran');
    }
};
