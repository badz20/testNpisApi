...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rp_sejarah_negeris', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('bahagian_id')->constrained('rp_permohonan_bahagian_details');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('rp_sejarah_negeri');
    }
};
